...
export function EmptyState({ 
  ...
  return (
    <div className={`flex flex-col items-center justify-center h-full text-slate-500 dark:text-slate-400 p-8 ${className}`}>
      ...
      <p className="text-center text-sm max-w-sm leading-relaxed mb-6">{subtitle}</p>
...
export function Button({
  ...
  const baseClasses = "inline-flex items-center justify-center font-medium rounded-lg transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
