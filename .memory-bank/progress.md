...
### ✅ 视频播放器修复完成 (2025-06-22)

- **完成时间**: 2025-06-22 22:00
- **问题**: TypeError: window.electronAPI.getVideoUrl is not a function
- **解决方案**: IPC 通信修复 + webSecurity 禁用 + file://协议
- **影响**: 应用现在支持完整的视频+字幕学习流程
